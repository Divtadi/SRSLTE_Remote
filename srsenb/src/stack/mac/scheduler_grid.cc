...
alloc_outcome_t sf_grid_t::alloc_ul_data(sched_ue* user, ul_harq_proc::ul_alloc_t alloc, bool needs_pdcch) {
    ...
    if (user != nullptr) {
        ...
        if (user->get_qci() == 7) {
            ...
            std::cout << "This is the end position of mask insise the QCI7: " << alloc.RB_start + (alloc.L / 2)
                      << std::endl
                      << "/n";
        ...
        if (user->get_qci() == 9) {
            ...
            std::cout << "This is the End position of mask inside QCI9: " << alloc.RB_start + alloc.L << std::endl
                      << "/n";
