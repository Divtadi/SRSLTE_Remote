...
public:
  ...
  public:
    ...
    virtual void sched_users_s1(std::map<uint16_t, sched_ue>& ue_db, ul_sf_sched_itf* tti_sche) = 0;//Divya
    virtual void sched_users_s2(std::map<uint16_t, sched_ue>& ue_db, ul_sf_sched_itf* tti_sche) = 0;//Divya
  };
